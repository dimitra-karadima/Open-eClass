...
<script type='text/javascript' src='$urlAppend/include/xinha/my_config.js'></script>";
	...
	$restitle = stripslashes( $restitle );
  $restitle = mysql_real_escape_string( $restitle );
  $restitle = htmlspecialchars( $restitle );
	$rescomments = stripslashes( $rescomments );
  $rescomments = mysql_real_escape_string( $rescomments );
  $rescomments = htmlspecialchars( $rescomments );
	if ($id = check_admin_unit_resource($res_id)) {
